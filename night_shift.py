...
MODEL ROUTING:
  Writer  → Qwen3.5-35B-A3B-FP8  (10.0.0.13:8000) — creative generation, faster
...
# Writer:  10.0.0.13 (Rivet2) — Qwen3.5-35B-A3B-FP8 (faster, creative generation)
...
WRITER_MODEL  = "Qwen/Qwen3.5-35B-A3B-FP8"
